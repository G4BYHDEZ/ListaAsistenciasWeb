...
export default function AttendancePage() {
  ...
  useEffect(() => {
    if (view === 'attendance') {
      fetch(`http://listaalumnos.utportfolio.cloud:5000/api/courses/${courseId}/attendance/${date}`)
        .then(res => res.json())
  ...
  useEffect(() => {
    if (view === 'report') {
      fetch(`http://listaalumnos.utportfolio.cloud:5000/api/courses/${courseId}/summary`)
        .then(res => res.json())
        .then(data => setReportList(data))
        .catch(err => console.error(err));
    } else if (view === 'history') {
      fetch(`http://listaalumnos.utportfolio.cloud:5000/api/courses/${courseId}/history`)
        .then(res => res.json())
